...
import { faBars, faHome, faSearch, faShoppingCart, faCreditCard, faEnvelope, faUser, faBoxOpen, faTooth } from "@fortawesome/free-solid-svg-icons";
   ...
   return (
      <div className="nav">
         <div className="inner-content">
            <h1 className="logo">
            <FontAwesomeIcon icon={faTooth} className="logo-icon" />   
